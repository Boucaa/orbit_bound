...
class GameBloc extends Bloc<GameEvent, GameState> {
  ...
  GameBloc()
    ...
    //       final k2Velocity =
    //           calcAcceleration(objects[i].position + k1Position * 0.5) *
    //               timeStep;
    //       final k2Position =
    //           (objects[i].velocity + k1Velocity * 0.5) * timeStep;
    //
    //       // Calculate the k3 values
    //       final k3Velocity =
    //           calcAcceleration(objects[i].position + k2Position * 0.5) *
    //               timeStep;
    //       final k3Position =
    //           (objects[i].velocity + k2Velocity * 0.5) * timeStep;
    //
    //       // Calculate the k4 values
    //       final k4Velocity =
    //           calcAcceleration(objects[i].position + k3Position) * timeStep;
    //       final k4Position = (objects[i].velocity + k3Velocity) * timeStep;
    //
    //       // Update the velocity and position
    //       final newVelocity = objects[i].velocity +
    //           (k1Velocity + k2Velocity * 2 + k3Velocity * 2 + k4Velocity) *
    //               (1 / 6);
    //       final newPosition = objects[i].position +
    //           (k1Position + k2Position * 2 + k3Position * 2 + k4Position) *
    //               (1 / 6);
    //
    //       // final newVelocity =
    ...
    //         position:
    //             newPosition, //objects[i].position + newVelocity * (16000*0.000001),
    //       );
